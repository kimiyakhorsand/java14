...
buttonn.addEventListener("click" , (e)=> {
    ...
    // const creatnewtod = (inputt , textareaa , id , checked) => {
  ...
  todoInput.defaultValue = inputt.value;
...
let savedTodos2 = [...parseSavedTodos];
...
mainlist.addEventListener("click" , (e)=> {
  ...
  const filtredTodos = savedTodos2.filter(
